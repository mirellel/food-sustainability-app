...
# load data
food_consumption = pd.read_csv("/Users/hyvatmerkit/interactive_data_visualisation/idv_project/idv_project/src/data/Luke_Maa_Ravtase_03_20250413-163420.csv")
